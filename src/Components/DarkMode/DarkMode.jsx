...
const DarkMode = () => {
    ...
    return (
      <div className="App">
        ...
        >
          {darkMode ? <> <p style={{"fontSize":"18px", "display":"inline"}}>Light Mode </p><i class="fa-solid fa-sun" style={{"color":"#FFD43B"}}></i> </>: <><p style={{"fontSize":"18px", "display":"inline"}}>Dark Mode </p><i class="fa-solid fa-moon" style={{"color": "#74C0FC"}}></i></>}
